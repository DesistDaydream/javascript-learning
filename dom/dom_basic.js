...
var updateContentButtonObject = document.getElementById("update_content_button")
// 获取文本
...
read_attribute_button.onclick = function () {
    console.log("元素的原生属性:\n", "id:", operateAttribute.id, "\n", "type:", operateAttributeInput.type)
    console.log("元素的自定义属性:\n", operateAttribute.getAttribute('custom_attribute'))
}
// 改变属性
...
delete_attribute_button.onclick = function () {
    // 删除自定义属性
    operateAttribute.removeAttribute("custom_attribute")
}
...
read_style_button.onclick = function () {
    ...
    console.log("  宽:", operateStyle.style.width, "高:", operateStyle.style.height)
    // 获取非行内样式
    console.log("非行内样式:\n")
