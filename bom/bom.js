...
// ####浏览器的弹出层####
// 询问框
var confirmValue = window.confirm("询问框，该操作可以产生返回值。点确定返回 true，点取消返回 false")
// 提示框
window.alert("询问框返回值:" + confirmValue)
// 输入框
var promptValue = window.prompt("输入框，可以将用户输入的内容作为返回值，若取消输入则返回 null")
...
window.onscroll = function () {
    ...
    console.log("页面发生滚动了!卷去的高度尺寸为:", document.documentElement.scrollTop, "卷去的宽度尺寸为:", document.documentElement.scrollLeft)
}
